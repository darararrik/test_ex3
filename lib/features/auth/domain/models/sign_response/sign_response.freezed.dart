...
mixin _$SignResponse {
 ...
 ProblemModel? get problem; String get token; UserModel get user;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignResponse&&(identical(other.problem, problem) || other.problem == problem)&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
...
@override
String toString() {
  return 'SignResponse(problem: $problem, token: $token, user: $user)';
}
...
@useResult
$Res call({
 ProblemModel? problem, String token, UserModel user
});


$ProblemModelCopyWith<$Res>? get problem;$UserModelCopyWith<$Res> get user;
...
as ProblemModel?,token: null == token ? _self.token : token // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$ProblemModelCopyWith<$Res>? get problem {
    if (_self.problem == null) {
    return null;
  }

  return $ProblemModelCopyWith<$Res>(_self.problem!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProblemModel? problem,  String token,  UserModel user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProblemModel? problem,  String token,  UserModel user)  $default,) {final _that = this;
switch (_that) {
case _SignResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProblemModel? problem,  String token,  UserModel user)?  $default,) {final _that = this;
switch (_that) {
case _SignResponse() when $default != null:
return $default(_that.problem,_that.token,_that.user);case _:
  return null;
...
class _SignResponse implements SignResponse {
   _SignResponse({this.problem, required this.token, required this.user});
  factory _SignResponse.fromJson(Map<String, dynamic> json) => _$SignResponseFromJson(json);

@override final  ProblemModel? problem;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignResponse&&(identical(other.problem, problem) || other.problem == problem)&&(identical(other.token, token) || other.token == token)&&(identical(other.user, user) || other.user == user));
}
...
@override $ProblemModelCopyWith<$Res>? get problem;@override $UserModelCopyWith<$Res> get user;
